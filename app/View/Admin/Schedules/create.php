	...
	<div class="row justify-content-center">
		...
		<div class="col-lg-10">
			...
			<div class="card shadow mb-4">
					...
					<div class="d-flex justify-content-between align-items-center">
						...
						<div>
							...
							<p class="text-muted mb-0">
								...
								Buat jadwal pelaksanaan pelatihan baru.
				...
				<form
					method="POST"
					action="<?= url('/admin/schedules/store') ?>">
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									...
									<textarea
										...
										rows="5"
										class="form-control"
										placeholder="Catatan jadwal pelatihan..."></textarea>
